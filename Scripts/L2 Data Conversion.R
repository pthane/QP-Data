...
# Load databases
CEPT_Aspect = read_csv("./CSV Files/L2 Learners/CEPT Preterit Raw L2 Data.csv")
CEPT_Mood = read_csv("./CSV Files/L2 Learners/CEPT Subjunctive Raw L2 Data.csv")
...
# Write new CSV files
write_csv(CEPT_Aspect_Standardized, "./CSV Files/L2 Learners/CEPT Preterit Standardized L2 Data.csv")
...
write_csv(CEPT_Mood_Standardized, "./CSV Files/L2 Learners/CEPT Subjunctive Standardized L2 Data.csv")
