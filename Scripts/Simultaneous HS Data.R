...
# Preparation of data
## Load database
EPT_Aspect_Data = read_csv("./CSV Files/Simultaneous/Simultaneous EPT Preterit Data.csv")
FCT_Aspect_Data = read_csv("./CSV Files/Simultaneous/Simultaneous FCT Preterit Data.csv")
EPT_Mood_Data = read_csv("./CSV Files/Simultaneous/Simultaneous EPT Subjunctive Data.csv")
FCT_Mood_Data = read_csv("./CSV Files/Simultaneous/Simultaneous FCT Subjunctive Data.csv")
Aspect_Composite = read_csv("./CSV Files/Simultaneous/Simultaneous Aggregate Preterit Data.csv")
Mood_Composite = read_csv("./CSV Files/Simultaneous/Simultaneous Aggregate Subjunctive Data.csv")
