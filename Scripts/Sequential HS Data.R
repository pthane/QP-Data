...
# Preparation of data
## Load database
EPT_Aspect_Data = read_csv("./CSV Files/Sequential/Sequential EPT Preterit Data.csv")
FCT_Aspect_Data = read_csv("./CSV Files/Sequential/Sequential FCT Preterit Data.csv")
EPT_Mood_Data = read_csv("./CSV Files/Sequential/Sequential EPT Subjunctive Data.csv")
FCT_Mood_Data = read_csv("./CSV Files/Sequential/Sequential FCT Subjunctive Data.csv")
Aspect_Composite = read_csv("./CSV Files/Sequential/Sequential Aggregate Preterit Data.csv")
Mood_Composite = read_csv("./CSV Files/Sequential/Sequential Aggregate Subjunctive Data.csv")
