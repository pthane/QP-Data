...
--
  + **Morphology Problem:** Infrequent morphological structures are prone to loss
...
--
- Implies shift in perspective and lack of commitment to truth value of subordinate clause (desire, obligation, preference, doubt, emotion, or speaker's affect)
...
--
- Effect of task for both groups
...
--
  + Main effect for proficiency in aggregate and production models

--
  + .RUred[No effect for frequency of use for HB]

--
  + Interaction between frequency of use and the frequency of the subordinate verb

--
  + Token frequency did not affect all HB in production/interpretation

--
  + Task-specific models did not reveal frequency effects
...
--
  + Proficiency affected use of subjunctive in all models

--
  + No relationship between proficiency and token frequency .RUred[not] upheld in production

--
  + Frequency of use modulated effects of token frequency of the matrix verb in interpretation
...
--
  + High degrees of exposure necessary to map lexical selection onto less-frequent items
