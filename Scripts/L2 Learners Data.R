...
Aspect_Composite = read_csv("./CSV Files/L2 Learners/L2 Learners Aggregate Preterit Data.csv")
...
Mood_Composite = read_csv("./CSV Files/L2 Learners/L2 Learners Aggregate Subjunctive Data.csv")


# Aspect GLMMs
## Aspect omnibus model
Aspect_Omnibus = glmer(
  Response ~ Task + Token_Main_Std * Reg_Main * DELE_Std +
...
Aspect_Production = glmer(
  Response ~ Token_Main_Std * Reg_Main * DELE_Std +
    (1 | Participant_ID) + (1 | Item),
