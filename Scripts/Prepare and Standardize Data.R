...
EPT_Aspect_Simultaneous <- EPT_Aspect %>%
  filter(HerGroup == "Simultaneous")

EPT_Mood_Simultaneous <- EPT_Mood_Adjusted %>%
  filter(HerGroup == "Simultaneous")

FCT_Aspect_Simultaneous <- FCT_Aspect %>%
  filter(HerGroup == "Simultaneous")

FCT_Mood_Simultaneous <- FCT_Mood_Adjusted %>%
  filter(HerGroup == "Simultaneous")

Aggregate_Aspect_Simultaneous <- Aggregate_Aspect %>% 
  filter(HerGroup == "Simultaneous")
...
EPT_Aspect_Sequential <- EPT_Aspect %>%
  filter(HerGroup == "Sequential")

EPT_Mood_Sequential <- EPT_Mood_Adjusted %>%
  filter(HerGroup == "Sequential")

FCT_Aspect_Sequential <- FCT_Aspect %>%
  filter(HerGroup == "Sequential")

FCT_Mood_Sequential <- FCT_Mood_Adjusted %>%
  filter(HerGroup == "Sequential")

Aggregate_Aspect_Sequential <- Aggregate_Aspect %>% 
  filter(HerGroup == "Sequential")
...
## Aspect data
### Aspect EPT
EPT_Aspect_Simultaneous <- EPT_Aspect_Simultaneous %>%
  mutate(FofA = FofA_Prod + FofA_Comp) %>%
  mutate(Token_Differential = Token_Main_Imp - Token_Main_Pret) %>%
  mutate(FofA_Std = (FofA - mean(FofA))/sd(FofA),
         FofA_Prod_Std = (FofA_Prod - mean(FofA_Prod))/sd(FofA_Prod),
...
### Aspect FCT
FCT_Aspect_Simultaneous <- FCT_Aspect_Simultaneous %>%
  mutate(FofA = FofA_Prod + FofA_Comp) %>%
  mutate(Token_Differential = Token_Main_Imp - Token_Main_Pret) %>%
  mutate(FofA_Std = (FofA - mean(FofA))/sd(FofA),
         FofA_Prod_Std = (FofA_Prod - mean(FofA_Prod))/sd(FofA_Prod),
...
### Aspect aggregate
Aggregate_Aspect_Simultaneous = Aggregate_Aspect_Simultaneous %>%
  mutate(FofA = FofA_Prod + FofA_Comp) %>%
  mutate(Token_Differential = Token_Main_Imp - Token_Main_Pret) %>%
  mutate(FofA_Std = (FofA - mean(FofA))/sd(FofA),
         FofA_Prod_Std = (FofA_Prod - mean(FofA_Prod))/sd(FofA_Prod),
...
## Aspect data
### Aspect EPT
EPT_Aspect_Sequential <- EPT_Aspect_Sequential %>%
  mutate(FofA = FofA_Prod + FofA_Comp) %>%
  mutate(Token_Differential = Token_Main_Imp - Token_Main_Pret) %>%
  mutate(FofA_Std = (FofA - mean(FofA))/sd(FofA),
         FofA_Prod_Std = (FofA_Prod - mean(FofA_Prod))/sd(FofA_Prod),
...
### Aspect FCT
FCT_Aspect_Sequential <- FCT_Aspect_Sequential %>%
  mutate(FofA = FofA_Prod + FofA_Comp) %>%
  mutate(Token_Differential = Token_Main_Imp - Token_Main_Pret) %>%
  mutate(FofA_Std = (FofA - mean(FofA))/sd(FofA),
         FofA_Prod_Std = (FofA_Prod - mean(FofA_Prod))/sd(FofA_Prod),
...
### Aspect aggregate
Aggregate_Aspect_Sequential = Aggregate_Aspect_Sequential %>%
  mutate(FofA = FofA_Prod + FofA_Comp) %>%
  mutate(Token_Differential = Token_Main_Imp - Token_Main_Pret) %>%
  mutate(FofA_Std = (FofA - mean(FofA))/sd(FofA),
         FofA_Prod_Std = (FofA_Prod - mean(FofA_Prod))/sd(FofA_Prod),
...
write_csv(EPT_Aspect_Simultaneous, "./CSV Files/Simultaneous/Simultaneous EPT Preterit Data.csv")
write_csv(EPT_Mood_Simultaneous, "./CSV Files/Simultaneous/Simultaneous EPT Subjunctive Data.csv")
write_csv(FCT_Aspect_Simultaneous, "./CSV Files/Simultaneous/Simultaneous FCT Preterit Data.csv")
write_csv(FCT_Mood_Simultaneous, "./CSV Files/Simultaneous/Simultaneous FCT Subjunctive Data.csv")
write_csv(Aggregate_Aspect_Simultaneous, "./CSV Files/Simultaneous/Simultaneous Aggregate Preterit Data.csv")
write_csv(Aggregate_Mood_Simultaneous, "./CSV Files/Simultaneous/Simultaneous Aggregate Subjunctive Data.csv")

## Sequential Bilinguals
write_csv(EPT_Aspect_Sequential, "./CSV Files/Sequential/Sequential EPT Preterit Data.csv")
write_csv(EPT_Mood_Sequential, "./CSV Files/Sequential/Sequential EPT Subjunctive Data.csv")
write_csv(FCT_Aspect_Sequential, "./CSV Files/Sequential/Sequential FCT Preterit Data.csv")
write_csv(FCT_Mood_Sequential, "./CSV Files/Sequential/Sequential FCT Subjunctive Data.csv")
write_csv(Aggregate_Aspect_Sequential, "./CSV Files/Sequential/Sequential Aggregate Preterit Data.csv")
